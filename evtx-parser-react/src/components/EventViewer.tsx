					...
					<>
						...
						>
							<Group justify='space-between' wrap='wrap'>
								<Group gap='sm'>
									...
									<div>
										<Group gap='xs'>
											...
											<Badge
												color={LEVEL_COLORS[selectedEvent.level] ?? 'gray'}
											>
								...
								<Group gap='xs'>
									<Tooltip
										label={clipboard.copied ? 'Copied!' : 'Copy as JSON'}
									>
										<ActionIcon
								...
								<Tabs.Panel h='100%' value='general'>
									<ScrollArea h='100%' p='md'>
										<Stack gap='md'>
											...
											<DetailRow
												label='Process ID'
												value={selectedEvent.processId}
											/>
											<DetailRow
												label='Thread ID'
												value={selectedEvent.threadId}
											/>
											...
											<DetailRow
												label='Keywords'
												mono={true}
												value={selectedEvent.keywords}
											/>
											<DetailRow
												label='Version'
												value={selectedEvent.version}
											/>
											<DetailRow
												label='Record ID'
												value={selectedEvent.recordId.toString()}
											/>
											...
											{selectedEvent.securityUserId && (
												<>
													...
													<DetailRow
														label='User ID'
														mono={true}
														value={selectedEvent.securityUserId}
													/>
												</>
											)}
												...
												<>
													...
													{selectedEvent.activityId && (
														<DetailRow
															label='Activity ID'
															mono={true}
															value={selectedEvent.activityId}
														/>
													)}
													{selectedEvent.relatedActivityId && (
														<DetailRow
															...
															mono={true}
															value={selectedEvent.relatedActivityId}
														/>
													)}
												</>
											)}
